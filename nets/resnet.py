...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,k_size=3):
        ...
        # self.erca = ERCA_MALayer(planes * 4, k_size)  #以后用ERCALayer
...
def resnet50():
    model = ResNet(Bottleneck, [3, 4, 6, 3])#ResNet101([3, 4, 23, 3])，ResNet152([3, 8, 36, 3])，ResNet18([2, 2, 2, 2])，ResNet34([3, 4, 6, 3])
    #----------------------------------------------------------------------------#
...
def resnet101():
    model = ResNet(Bottleneck, [3, 4, 23,
                                3])  # ResNet101([3, 4, 23, 3])，ResNet152([3, 8, 36, 3])，ResNet18([2, 2, 2, 2])，ResNet34([3, 4, 6, 3])
    # ----------------------------------------------------------------------------#
    #   获取特征提取部分，从conv1到model.layer3，最终获得一个38,38,1024的特征层
    # ----------------------------------------------------------------------------#
    features = list([model.conv1, model.bn1, model.relu, model.maxpool, model.layer1, model.layer2, model.layer3])
